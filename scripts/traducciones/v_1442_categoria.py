...
ROWS = [
    ...
    ("fabricados por Cartotecnica Hores. Aptos para contacto alimentario, consultá por WhatsApp.",
     "fabricados por Cartotecnica Hores. Aptos para contacto alimentario, consultá por WhatsApp.",
     "made by Cartotecnica Hores. Suitable for food contact, ask us on WhatsApp.",
     "fabricados pela Cartotecnica Hores. Próprios para contato com alimentos, consulte pelo WhatsApp.",
     "prodotti da Cartotecnica Hores. Adatti al contatto alimentare, contattaci su WhatsApp.",
     "fabriqués par Cartotecnica Hores. Adaptés au contact alimentaire, contactez-nous sur WhatsApp.",
     "hergestellt von Cartotecnica Hores. Für Lebensmittelkontakt geeignet, kontaktieren Sie uns über WhatsApp.",
     "由Cartotecnica Hores生产。适合接触食品，欢迎通过WhatsApp咨询。"),
