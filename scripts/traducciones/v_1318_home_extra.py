...
ROWS = [
    ...
    ('Planta Cartotecnica Hores — vista aérea',
     'Planta Cartotecnica Hores — vista aérea',
     'Cartotecnica Hores facility — aerial view',
     'Planta da Cartotecnica Hores — vista aérea',
     'Stabilimento Cartotecnica Hores — vista aerea',
     'Usine Cartotecnica Hores — vue aérienne',
     'Cartotecnica-Hores-Werk — Luftaufnahme',
     'Cartotecnica Hores 工厂 — 航拍图'),

    ('Planta de Cartotecnica Hores en Bell Ville',
     'Planta de Cartotecnica Hores en Bell Ville',
     'Cartotecnica Hores facility in Bell Ville',
     'Planta da Cartotecnica Hores em Bell Ville',
     'Stabilimento Cartotecnica Hores a Bell Ville',
     'Usine Cartotecnica Hores à Bell Ville',
