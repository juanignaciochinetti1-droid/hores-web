...
ROWS = [
    ...
    ("Buscar producto (ej: budín, rosca...)", "Buscar producto (ej: budín, rosca...)",
     "Search product (e.g.: pound cake, ring cake...)", "Buscar produto (ex: bolo inglês, rosca...)",
     "Cerca prodotto (es: plumcake, ciambella...)", "Rechercher un produit (ex : cake, couronne...)",
     "Produkt suchen (z. B.: Kastenform, Kranzkuchen...)", "搜索产品（例如：磅蛋糕、环形蛋糕……）"),
    ("No encontramos productos que coincidan con tu búsqueda.", "No encontramos productos que coincidan con tu búsqueda.",
     "We couldn't find any products matching your search.", "Não encontramos produtos que correspondam à sua busca.",
     "Non abbiamo trovato prodotti corrispondenti alla tua ricerca.", "Nous n'avons trouvé aucun produit correspondant à votre recherche.",
     "Wir haben keine passenden Produkte zu Ihrer Suche gefunden.", "未找到与您的搜索匹配的产品。"),
